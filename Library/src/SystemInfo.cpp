...
namespace ZGF
{
	...
	unsigned long long SystemInfo::GetCPUUsage()
	{
		FILETIME dummy;
		FILETIME kerneltime;
		FILETIME usertime;
	...
	unsigned long long SystemInfo::GetRAMUsage()
	{
	...
	unsigned long long SystemInfo::GetTickCount()
	{
		return ::GetTickCount();
	}
