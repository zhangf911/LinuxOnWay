...
bool NetBuffer::OnReceived( std::size_t transferred )
{
	...
	unsigned int nLenght = m_simpleRecvBuff.GetLength();
...
// 		{
// 			NET_LOG("ÑÏÖØ´íÎó,·¢ËÍ»º³åÇøÎÞ·¨Ð´Èë£¬°ü¶ªÊ§");
// 			MY_ASSERT(false,"",;);
// 		}
